...
export default function LoadingSpinnerOverlay() {
    return (
        <div
            ...
            // `z-[9999]` ensures it is on top of almost everything else
            // `bg-black bg-opacity-10` provides a subtle overlay
            className="fixed inset-0 w-screen h-screen z-[9999] flex items-center justify-center bg-black bg-opacity-10"
